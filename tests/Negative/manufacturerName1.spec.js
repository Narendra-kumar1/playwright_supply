...
test("manufacturer  name with more than 14 characters @Adhoc",async({page})=>{
    ...
    await AddEditManufacturerPage.AddManufacturerFunctionality({...data,username:"abcdefghijklmnopqrdd"});
